...
The project now has a working Phase 1 and Phase 2 implementation. These documents are living planning artifacts: some describe implemented behavior, while later-phase documents describe the intended direction.
