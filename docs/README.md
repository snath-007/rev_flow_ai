...
The project has a working Phase 1 through Phase 5 implementation plus the core Phase 6 authentication, tenancy, payment, reporting, integration, and deployment-preparation milestones. Live deployment and hardening items remain explicitly tracked.
...
| [Free-Tier Deployment](./deployment-free-tier.md)                                           | Two-project Vercel, Neon, Clerk, and Gemini hosted-demo setup                                       |
...
| [ADR 0003 - Hosted Demo Topology](./adr/0003-hosted-demo-topology.md)                       | Separate Vercel web/API projects, managed Postgres, and optional worker topology                    |
| [ADR 0004 - AI Hosting And Provider Policy](./adr/0004-ai-hosting-and-provider-policy.md)   | Gemini API integration with deterministic mock fallback and provider-neutral boundaries             |
