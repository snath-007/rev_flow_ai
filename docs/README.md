...
The project has not been implemented yet, so these documents are intentionally written as executable planning artifacts: they define what we will build, why it matters, and how each module should behave once code exists.
